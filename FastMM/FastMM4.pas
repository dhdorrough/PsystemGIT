...
Usage:
 Delphi:
  ...
  (inside ) that may be used to tweak the memory manager. To
  enable support FastMM4Options.incfor a user mode address space greater than 2GB you will have to
