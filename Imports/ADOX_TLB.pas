...
// PASTLWTR : 1.2
// File generated on 12/10/2014 12:54:35 PM from Type Library described below.
...
//   Hint: Symbol 'Type' renamed to 'type_'
//   Hint: Symbol 'Type' renamed to 'type_'
//   Error creating palette bitmap of (TADOXTable) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXColumn) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXIndex) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXKey) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXGroup) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXUser) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOXCatalog) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
